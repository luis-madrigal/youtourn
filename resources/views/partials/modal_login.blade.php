	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" align="center">
				<img class="img-circle" id="img_logo" src="images/ytsmalllogocircle.png">
            ...
            <div id="div-forms">
                ...
                <!-- Begin | Register Form -->
                <form id="register-form" action = "{{ route('signup') }}" method = "post" style="display:none;">
        		    <div class="modal-body">
                        ...
                        <input id="register_firstname" class="form-control" type="text" placeholder="First name" name = "first_name" required>
                        <input id="register_lastname" class="form-control" type="text" placeholder="Last name" name = "last_name" required>
                        ...
                        <div id = "register_gender centered-content" style = "padding:10px;">
